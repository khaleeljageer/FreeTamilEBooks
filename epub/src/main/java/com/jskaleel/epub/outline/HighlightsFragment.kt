...
import com.jskaleel.epub.databinding.ItemRecycleHighlightBinding
...
class HighlightsFragment : Fragment() {
    ...
    private fun onHighlightSelected(highlight: EBookHighlight) {
        setFragmentResult(
...
class HighlightAdapter(
    ...
    private val onDeleteHighlightRequested: (EBookHighlight) -> Unit,
    private val onHighlightSelectedRequested: (EBookHighlight) -> Unit,
) :
    ListAdapter<EBookHighlight, HighlightAdapter.ViewHolder>(HighlightsDiff()) {
    ...
    inner class ViewHolder(val binding: ItemRecycleHighlightBinding) : RecyclerView.ViewHolder(
        ...
        fun bind(highlight: EBookHighlight) {
...
private class HighlightsDiff : DiffUtil.ItemCallback<EBookHighlight>() {

    override fun areItemsTheSame(oldItem: EBookHighlight, newItem: EBookHighlight): Boolean =
        oldItem.id == newItem.id

    override fun areContentsTheSame(oldItem: EBookHighlight, newItem: EBookHighlight): Boolean =
        oldItem == newItem
}
