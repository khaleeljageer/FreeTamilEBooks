...
import com.jskaleel.epub.databinding.FragmentReaderBinding
import com.jskaleel.epub.reader.tts.TtsControls
...
import com.jskaleel.epub.utils.observeWhenStarted
import com.jskaleel.epub.utils.padSystemUi
import com.jskaleel.epub.utils.showSystemUi
import com.jskaleel.epub.utils.toggleSystemUi
...
abstract class VisualReaderFragment : BaseReaderFragment() {
                ...
                event.rect?.let { rect ->
                    ...
                    showHighlightPopup(
                        ...
                        style = if (isUnderline) {
                            EBookHighlight.Style.UNDERLINE
                        } else {
                            EBookHighlight.Style.HIGHLIGHT
                        },
                        highlightId = id
                    )
                }
    ...
    private inner class SelectionActionModeCallback : BaseActionModeCallback() {
        ...
        override fun onActionItemClicked(mode: ActionMode, item: MenuItem): Boolean {
            when (item.itemId) {
                R.id.highlight -> showHighlightPopupWithStyle(EBookHighlight.Style.HIGHLIGHT)
                R.id.underline -> showHighlightPopupWithStyle(EBookHighlight.Style.UNDERLINE)
    ...
    private fun showHighlightPopupWithStyle(style: EBookHighlight.Style) {
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            with(view) {
                ...
                if (highlight != null) {
                    ...
                    findViewById<TextView>(R.id.positive).setOnClickListener {
                        model.addHighlight(
                            locator = selection.locator,
                            style = EBookHighlight.Style.HIGHLIGHT,
                            tint = tint,
