...
class MediaService : MediaSessionService() {
    ...
    inner class Binder : android.os.Binder() {
        ...
        private val app: ReadiumApplication
            get() = application as ReadiumApplication
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val readerRepository = (application as ReadiumApplication).readerRepository
    ...
    companion object {
        ...
        const val SERVICE_INTERFACE = "com.jskhaleel.reader.reader.MediaService"
