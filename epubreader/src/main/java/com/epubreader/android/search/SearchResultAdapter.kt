...
import com.epubreader.android.databinding.ItemRecycleSearchBinding
import com.epubreader.android.utils.singleClick
...
class SearchResultAdapter(private var listener: Listener) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.textView.text = Html.fromHtml(html, Html.FROM_HTML_MODE_COMPACT)
    ...
    inner class ViewHolder(private val binding: ItemRecycleSearchBinding) :
